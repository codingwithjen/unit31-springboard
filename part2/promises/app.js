...
$.getJSON(`${baseURL}/new/draw/`)
    .then(data => {
        ...
        let sameDeck = data.deck_id;
        return $.getJSON(`${baseURL}/${sameDeck}/draw/`);
    })
    .then(data => {
...
// to create a new deck, and show a button the page that will let you draw a card. Every time you click the button,
